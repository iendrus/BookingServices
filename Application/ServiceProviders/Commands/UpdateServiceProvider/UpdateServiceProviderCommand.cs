...
{
    public class UpdateServiceProviderCommand : IRequest<int>, IMapFrom<UpdateServiceProviderCommand>
    {
        ...
        {
            profile.CreateMap<UpdateServiceProviderCommand, ServiceProvider>()
